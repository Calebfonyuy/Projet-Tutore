    ...
    <body class="bg-dark text-white">
        ...
        <div class="container-fluid content">
            ...
            <div class="col-lg-3 col-md-3 bg-info">
                ...
                <fieldset>
                    <ul class="none-list">
                        ...
                        <li><a class="list-group-item list-group-item-action active">Medecins</a>
                        </li>
            ...
            <div class="col-lg-9 col-md-9 text-wrap display">
                <h3 class="text-justify text-uppercase">Liste des medecins</h3>
                <table class="table text-white">
                    ...
                    <tbody>
                        <c:forEach items="${specialists}" var="pat">
                            <tr>
