    ...
    <body class="bg-dark text-white">
        ...
        <div class="container-fluid content">
            ...
            <div class="col-lg-3 col-md-3 bg-info">
                ...
                <fieldset>
                    <ul class="none-list">
                        ...
                        <li><a
                                class="list-group-item list-group-item-action active">Modifier mon
                                profile</a></li>
                    </ul>
                </fieldset>
            </div>
            ...
            <div class="col-lg-9 col-md-9 text-wrap display">
                <h3>Modifier votre profile: ${personel.id}</h3>
                <fieldset>
                    <form action="admin_profil" method="post">
                        <table class="table text-white">
                            <tr>
                                <td>Nom</td>
                                <td><input type="text" name="name" id="name" class="form-control" value="${personel.name}"
                                        required="required"></td>
                            </tr>
                            <tr>
                                <td>Prenom</td>
                                <td><input type="text" name="surname" id="surname"
                                        value="${personel.surname}" class="form-control" required="required"></td>
                            </tr>
                            <tr>
                                <td>Adresse</td>
                                <td><input type="text" name="address" id="address"
                                        class="form-control"
                                        value="${personel.address}" required="required"></td>
                            </tr>
                            <tr>
                                <td>Contact</td>
                                <td><input type="tel" name="telephone" id="telephone"
                                        class="form-control"
                                        value="${personel.contact}" required="required"></td>
                            </tr>
                            <tr>
                                <td>Mot de passe</td>
                                <td><input type="password" name="password" id="password"
                                        class="form-control"
                                        value="${personel.password}" required="required"></td>
                            </tr>
                            <tr>
